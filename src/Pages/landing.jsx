...
{/* Moving CompaniesName */}
    ...
    className="w-full py-10">
      <CarouselContent className="flex gap-7 sm:gap-20 items-center">
      ...
      <Accordion type="multiple" className="w-full cursor-pointer">
        {faqs.map((faq, index) => (
          <AccordionItem key={index} value={`item-${index + 1}`}>
            <AccordionTrigger className="font-bold text-xl ">{faq.question}</AccordionTrigger>
